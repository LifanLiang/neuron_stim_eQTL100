...
venn.diagram(list(GABA.pip1$genename, nmglut.pip1$genename, npglut.pip1$genename), filename = "docs/assets/venn_egenes.svg", category.names = c("GABA","nmglut","npglut"), output=T, fill=myCol, lty="blank", lwd=2, cat.fontface = "bold", fontface="bold", cex =2, cat.cex = 2, cat.fontfamily = "sans", fontfamily="sans")
```

![Overlap of top genes](assets/venn_egenes.svg)
