...
### Overlap of eGenes across celltypes
...
venn.diagram(list(GABA.pip1$genename, nmglut.pip1$genename, npglut.pip1$genename), filename = "docs/assets/venn_egenes.png", category.names = c("GABA","nmglut","npglut"), output=T, fill=myCol, lty="blank", lwd=2, cat.fontface = "bold", fontface="bold", cex =2, cat.cex = 2, cat.fontfamily = "sans", fontfamily="sans")
```

![Overlap of top genes](docs/assets/venn_egenes.png)
...
```{r,echo=F}
library(ggplot2)
dat <- data.frame(Ngenes=c(30,35,27,21,1,7), celltype=rep(c("GABA","nmglut","npglut"),2),
...
![GPR137 locus](docs/assets/multigroup_locus_plot_GPR137.png)


![NGEF locus](docs/assets/multigroup_locus_plot_NGEF.png)
