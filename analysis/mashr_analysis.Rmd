...
Therefore, for each gene, we computed $R^2$ among the lead variants based on genotypes of the 100 cell lines. SNP pairs with $R^2>0.5$ were pruned. After pruning, we obtained 57398 SNP-gene pairs.

These SNP-gene pairs were utilized as the strong subset for MASH analysis and we rerun the previous procedure.
