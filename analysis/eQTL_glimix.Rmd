...
Null model, alternative model, and likelihood ratio testing are identical to previous precedure except the the ratio of the random effects are fixed beforehand. We continue to use Beta approaximation to obtain adjusted P values for each gene.

Below is the QQ plot between Beta P values and empirical P values. Although a little too stringent, Beta approximation is quite accurate in the tail.
