...
Given the total sample size of 38 and 143 and the MAF, we sample the number of heterozygote individuals for each loci and then sampled the read counts given various allelic bias.
