...
### Simulation with different minor allele frequence (MAF) from the total sample sizes

Given the total cell line size of 38 and 143, we sample the number of heterozygote individuals with different MAF.
