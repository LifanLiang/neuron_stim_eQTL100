...
Figure \@ref(fig:sigcount) shows that significant drops after SNP aggregation and then increases through gene and locus level aggregation. SNP level detects less significant units because most cPeaks at one timepoint correspond to one SNP only (Figure \@ref(fig:peak2snp).
