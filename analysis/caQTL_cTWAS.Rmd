...
For each cell type, if an allelic specific open chromatin (ASoC) SNP is within 500 bps upstream and downstream of a cPeak and the matched cPeak has GWAS PIP > 0.8, then they shared the same signal.
