---
title: "cTWAS Results: Neuron Stimulation eQTL for Bipolar"
author: "Lifan Liang"
date: "2024-04-11"
...
Total PVE from all eGenes in all contexts is 12.49%.
...
There are 55 egenes if the cutoff was set to PIP>0.5.

```{r, echo=F}
res <- readRDS("data/bipolar_ctwas_noSNP_res.RDS")
...
![](docs/assets/venn_SCZ_vs_bipolar.png)
...
GABA has 18 eGenes, 8 of them are dynamic.
...
nmglut has 12 eGenes, 11 of them are dynamic.
...
npglut has 18 eGenes, 11 of them are dynamic.
