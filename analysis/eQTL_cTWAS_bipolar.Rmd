...
Use the same set of eGenes as previous restuls.These eGenes are the unions of eGenes across all cell types. CONTENT will produce tissue-specific weights for that gene if it has nonzeros weights in that certain tissue.
