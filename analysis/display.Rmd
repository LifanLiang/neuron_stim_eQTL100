...
![Fig S. Effect size correlation with GTEx cerebellum](assets/beta_corr_nocombat_cerebellum.png)

<br><br>

![Fig 5. Effect size correlation with GTEx whole blood](assets/beta_corr_nocombat_wholeblood.png)

![Fig 5C. Concordance of eQTL effect direction between our eQTLs and GTEx cerebellum / whole blood tissue](assets/update_screenshot/Fig5C_bulk_vs_GTEx.png)

(assets/direction_proportion_cerebellum_vs_blood.png)
...
```{r,echo=F,fig.cap="Fig 5F. Storey's Pi analysis of dynamic eQTL in GTEx brain tissues"}
library(pheatmap)
...
![Fig 6A. PVE and enrichment for the 9 conditions across 5 NPD traits](assets/PVE_enrichment_npd.png)

<br>

![Fig S15D. Total percent of h2g across 5 NPD traits](assets/update_screenshot/FigS15D_h2g_eqtl_ctwas)
...
![Fig 7D. TORUS analysis of enrichment of ASoC in eQTL](assets/update_screenshot/Fig7D_torus_ASoC_eQTL.png
...
```{r,echo=F,fig.cap="Figure 8D. Barplots of h2g comparing caQTL cTWAS and eQTL cTWAS across 5 NPD traits."}
