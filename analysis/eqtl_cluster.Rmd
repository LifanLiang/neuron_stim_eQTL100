...
We used [CellRegMap](cellregmap.html) to test six different hypothesis with the candidate set. The first three utilized samples across 9 conditions altogether, while hypothesis 4-6 were tested with 3 conditions respectively.
