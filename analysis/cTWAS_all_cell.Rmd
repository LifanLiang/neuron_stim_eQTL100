...
GTEx.gene <- readRDS("data/hemisphere_ctwas_genelist.RDS")
# venn.diagram(x=list(GTEx.gene$stringent,res4$genename),
#              category.names = c("GTEx" , "neuron_stim"),
...
```{r,echo=F}
knitr::kable(res4[res4$genename %in% GTEx.gene$stringent,])
```
