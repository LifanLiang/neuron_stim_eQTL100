...
#ggsave("../Documents/neuron_stim/figure_pdf/FigS15F_dynamic_shared_with_GTEx.pdf",height=4,width=2.5)
```
...
pdf("docs/assets/Gene_PIP_heatmap.pdf",height = 4.2, width=4.2)
pheatmap(res40[res40$PIP_sum>0.8,c(3,6,9,4,7,10,5,8,11)],cluster_rows=F, cluster_cols=F,
         color = colorRampPalette(c("white","red"))(100), 
         annotation_row=res4[rownames(res40),c("timepoint","celltype")],
