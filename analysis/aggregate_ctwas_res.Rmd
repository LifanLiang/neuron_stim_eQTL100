...
```{r,echo=F}
plot(x=-log10(CROT.summary$CROT_eqtl$pvalue), y=CROT.summary$CROT_eqtl$beta,
     xlab="-log10 nominal P value", ylab="absolute effect size (beta)", 
     ylim=c(0,0.6), xlim=c(0,3.5))
text(-log10(CROT.summary$CROT_eqtl$pvalue), CROT.summary$CROT_eqtl$beta,
...
```{r,echo=F}
plot(x=-log10(ACADM.summary$ACADM_eqtl$pvalue), y=ACADM.summary$ACADM_eqtl$beta,
     xlab="-log10 nominal P value", ylab="absolute effect size (beta)", 
     ylim=c(0,0.8), xlim=c(0,3.5))
text(-log10(ACADM.summary$ACADM_eqtl$pvalue), ACADM.summary$ACADM_eqtl$beta,
