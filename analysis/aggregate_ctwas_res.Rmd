...
ggplot(dat,aes(x=condition,y=trait)) + geom_count(aes(color = PVE, size=enrichment)) +guides(color = 'legend') + theme_minimal() + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
```
